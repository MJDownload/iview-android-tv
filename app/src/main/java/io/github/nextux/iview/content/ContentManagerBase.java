...
import io.github.nextux.iview.api.ContentDatabaseCache;
import io.github.nextux.iview.api.EpisodeBaseModel;
import io.github.nextux.iview.api.PlayHistory;
import io.github.nextux.iview.api.PlayHistory$Table;

public abstract class ContentManagerBase {

    public static final String CONTENT_ID = "io.github.nextux.iview.CONTENT_ID";
    public static final String CONTENT_TAG = "io.github.nextux.iview.CONTENT_TAG";

    public static final String CONTENT_SHOW_LIST_FETCHING = "io.github.nextux.iview.CONTENT_SHOW_LIST_FETCHING";
    public static final String CONTENT_SHOW_LIST_START = "io.github.nextux.iview.CONTENT_SHOW_LIST_START";
    public static final String CONTENT_SHOW_LIST_DONE = "io.github.nextux.iview.CONTENT_SHOW_LIST_DONE";
    public static final String CONTENT_SHOW_LIST_ERROR = "io.github.nextux.iview.CONTENT_SHOW_LIST_ERROR";
    public static final String CONTENT_SHOW_LIST_PROGRESS = "io.github.nextux.iview.CONTENT_SHOW_LIST_PROGRESS";

    public static final String CONTENT_EPISODE_FETCHING = "io.github.nextux.iview.CONTENT_EPISODE_FETCHING";
    public static final String CONTENT_EPISODE_START = "io.github.nextux.iview.CONTENT_EPISODE_START";
    public static final String CONTENT_EPISODE_DONE = "io.github.nextux.iview.CONTENT_EPISODE_DONE";
    public static final String CONTENT_EPISODE_ERROR = "io.github.nextux.iview.CONTENT_EPISODE_ERROR";

    public static final String CONTENT_AUTH_FETCHING = "io.github.nextux.iview.CONTENT_AUTH_FETCHING";
    public static final String CONTENT_AUTH_START = "io.github.nextux.iview.CONTENT_AUTH_START";
    public static final String CONTENT_AUTH_DONE = "io.github.nextux.iview.CONTENT_AUTH_DONE";
    public static final String CONTENT_AUTH_ERROR = "io.github.nextux.iview.CONTENT_AUTH_ERROR";
